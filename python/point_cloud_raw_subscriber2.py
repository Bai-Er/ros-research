...
class PointsDeal(object):
	def __init__(self):
		...
		self.pub = rospy.Publisher("/points_distance", point_deal, queue_size=10)
	...
	def points_zero_degree_deal(self, points_degree_zero):
	...
	def publish_distance(self, pub, distance_list):
		Data_Pub = point_deal()
		Data_Pub.left_mean = distance_list[0] # x mean
		Data_Pub.left_std= distance_list[1] # x std
		Data_Pub.right_mean = distance_list[2] # y mean
		Data_Pub.right_std = distance_list[3] # x std
